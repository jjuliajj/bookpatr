    ...
    <main className="flex min-h-screen flex-col bg-paper-beige">
      ...
      <section className="pt-28 pb-20">
        <div className="container mx-auto px-6 md:px-12 max-w-5xl">
          {/* Back link */}
          <Link href="/cart" className="inline-flex items-center text-xs font-manrope font-bold text-charcoal/50 hover:text-coral transition-colors mb-8 uppercase tracking-widest gap-2 group">
          ...
          <div className="bg-white/60 backdrop-blur-sm rounded-3xl p-6 md:p-10 border border-charcoal/10 shadow-sm grid md:grid-cols-12 gap-8 lg:gap-12 items-start">
            ...
            <div className="md:col-span-7 space-y-8">
              <div>
                <h2 className="text-xl font-newsreader font-bold text-charcoal mb-4 flex items-center gap-2 border-b border-charcoal/10 pb-3">
                  <span className="w-6 h-6 rounded-full bg-coral text-white text-xs font-bold font-manrope flex items-center justify-center">1</span>
              ...
              <div>
                <h2 className="text-xl font-newsreader font-bold text-charcoal mb-4 flex items-center gap-2 border-b border-charcoal/10 pb-3">
                  <span className="w-6 h-6 rounded-full bg-coral text-white text-xs font-bold font-manrope flex items-center justify-center">2</span>
                  Payment Gateway
                </h2>
                
                <div className="space-y-3">
                  <div className="bg-white border-2 border-coral p-4 rounded-2xl flex items-center justify-between shadow-xs">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-full bg-coral/10 text-coral flex items-center justify-center">
                        <CreditCard className="w-4 h-4" />
                      </div>
                      <div>
                        <div className="text-xs font-bold text-charcoal font-manrope">Stripe Secure Checkout</div>
                        <div className="text-[11px] text-charcoal/50">Credit / Debit Card, Apple Pay, Google Pay</div>
                      </div>
                    </div>
            ...
            <div className="md:col-span-5">
              <div className="bg-gradient-to-br from-charcoal via-slate-900 to-indigo-950 text-paper-beige rounded-3xl p-6 md:p-8 shadow-xl border border-charcoal/20 space-y-6">
